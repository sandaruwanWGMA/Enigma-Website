  ...
  const [list, setList] = useState([
    {
      ...
      desc: "Participants must register as teams. Registration should be done through the ENIGMA website. Participants are expected to create a team name and a dedicated team email address (accessible by all members of the team)",
    },
    {
