    ...
    <section id="about">
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            A hackathon comprising two rounds, open to all undergraduates within
            the university.
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          problem-solving skills and gain a deeper understanding of mathematics
          and programming, and of course, have fun with your colleagues!
        </p>
      </div>
    </section>
  );
