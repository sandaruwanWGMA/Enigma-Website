...
export const RegisterNow = () => {
  ...
  const [pageHeight, setPageHeight] = useState(890);

  const [fieldStates, setFieldStates] = useState([0, 1, 0, 0, 0, 0, 0]);
  ...
  const handleLeaderWhatsappChange = (newLeaderWhatsapp) => {
    ...
    const error =
      errorNum === -1
        ? ""
        : errorNum === 0
        ? "LEADER WHATSAPP NUMBER IS REQUIRED."
        : errorNum === 1
  ...
  const handleNumberOfMembersChange = (newMemberCount) => {
    ...
    const error =
      errorNum === -1
        ...
        : errorNum === 2
        ? "AT LEAST 1 MEMBER SHOULD BE IN THE TEAM."
        : errorNum === 3
        ? "NO MORE THAN 3 MEMBERS SHOULD BE IN THE TEAM."
        : "UNKNOWN ERROR IN VALIDATION";
  ...
  return (
    <div className="bg-white flex flex-row justify-center w-full">
      ...
      <div className="w-full relative" style={{ height: pageHeight + "px" }}>
        ...
        <div
          className="relative left-[56px]"
          style={{ width: "calc(100% - 120px)", height: "170px" }}
        >
        ...
        >
          ...
          <div className="relative w-full h-[69px] justify-center align-middle">
            <div className="relative submit-frame">
              <button
                disabled={fieldStates.some((fieldState) => fieldState === 0)}
