...
import notice_board_tablet from "../../assets/images-contact-us/notice-board-tablet.svg";
    ...
    <section className="contactus-sec">
      ...
      <div className="profile-sec">
        ...
        <img
          ...
          alt="board"
        ></img>
        <div className="notice-board-tablet-dev">
          <img
            src={notice_board_tablet}
            className="notice-board-tablet"
            alt="board"
          />
        </div>
